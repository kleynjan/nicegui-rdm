...
class CrudComponent:
    """Base for ng_loba UI components needing client context capture.
...
class RowAction:
    ...
    icon: str                                                # Icon name (e.g., "send", "visibility")
...
class StoreComponent(CrudComponent):
    """Base class for UI components connected to a store.

    Provides:
    - Observer pattern: subscribes to store events for automatic refresh
